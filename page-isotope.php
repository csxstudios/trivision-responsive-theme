...
?>
			...
			*/
			...
			.home-buckets {background: repeating-linear-gradient(to bottom, #001f3f, #001f3f 54px, #004182 54px, #004182 300px);}			.home-buckets figure {position:relative;overflow:hidden;}			.home-buckets figcaption {position:absolute;height:100%;width:100%;top:100%;transition: .2s all ease-in-out;}			.home-buckets figure:hover figcaption {top:30px;}			.home-buckets figure img {opacity:1;transition: .2s all ease-in-out;}			.home-buckets figure:hover img {opacity:0;}			.bucket-text-title {font-size:200%;display:none!important;}			.bucket-text-title, .bucket-text-block {color:#fff;width:100%;text-align:center;text-transform:none;display:block;padding:30px;}
			...
			.bucket-red:hover h3 {background: rgba(242,11,104,1);opacity: 1;}
			.bucket-red:hover {background: linear-gradient(to bottom, rgba(242,111,104,0) 0%,rgba(242,111,104,0) 30%,rgba(242,111,104,1) 100%);}
			.bucket.bucket-red:hover h3::after {border-top: 20px solid rgba(242,11,104,100);opacity:1;}
			...
			.bucket.bucket-purple:hover h3::after {border-top: 20px solid rgba(113,66,154,100);opacity:1;}						.bucket-teal:hover h3 {background: rgba(101,203,201,1);opacity: 1;}			.bucket-teal:hover {background: linear-gradient(to bottom, rgba(101,203,201,0) 0%,rgba(101,203,201,0) 30%,rgba(101,203,201,1) 100%);}			.bucket.bucket-teal:hover h3::after {border-top: 20px solid rgba(101,203,201,100);opacity:1;}
			...
			<div class="grid" id="grid">
				...
				<div class="grid-item grid-item">
					<div id="carousel-partners" class="carousel slide carousel-fade carousel-isotope" data-ride="carousel" data-interval="3000" data-pause="hover">
					  <div class="carousel-inner" role="listbox">
						<div class="item active" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner-Partners-576×324.png);">
							<figure>
							<figcaption><a href="http://www.trivisionclients.com/drcc/partners/"><span>My Health Matters 5K/1 mile Walk event on May 20.</span></a></figcaption>
							</figure>
						</div>
						<div class="item" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner-Partners-576×324-2.png);">
							<figure>
							<figcaption><a href="http://www.trivisionclients.com/drcc/partners/"><span>This is the month to set your networking soaring! Register now for the Signature Flight Mixer on May 25.</span></a></figcaption>
							</figure>
						</div>
						<div class="item" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner-Partners-576×324-3.png);">
							<figure>
							<figcaption><a href="http://www.trivisionclients.com/drcc/partners/"><span>Break out the clubs and start warming up! It's time to register for the Annual Golf Scramble on June 9.</span></a></figcaption>
							</figure>
						</div>
					  </div>
					</div>
				...
				<div class="grid-item grid-item--width2">
					<div id="carousel-mixers" class="carousel slide carousel-fade carousel-isotope" data-ride="carousel" data-interval="3000" data-pause="hover">
					  <div class="carousel-inner" role="listbox">
						<div class="item active" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner-mixers-672×324.png);">
							<figure>
				...
				<div class="grid-item grid-item--width2">
					<div id="carousel-smb" class="carousel slide carousel-fade carousel-isotope" data-ride="carousel" data-interval="3000" data-pause="hover">
					  <div class="carousel-inner" role="listbox">
						<div class="item active" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner0small-business-672×324.png);">
							<figure>
						...
						<div class="item" style="background-image:url(http://www.trivisionclients.com/drcc/wp-content/uploads/2017/05/Homepage-Banner0small-business-672×324-3.png);">
							<figure>
