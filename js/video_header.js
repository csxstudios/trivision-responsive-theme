var HeaderVideo = (function ($, document) {
    ...
    var appendTeaserVideo = function() {
        if(!isMobile()) {
            var source = videoDetails.teaser,
                html = '<video autoplay="true" loop="loop" muted id="teaser-video" class="teaser-video"><source src="'+source+'.mp4" type="video/mp4" poster="http://www.trivisioncreative.com/wp-content/themes/CreativeTheme/video/loop.jpg"><source src="'+source+'.ogv" type="video/ogg" poster="http://www.trivisioncreative.com/wp-content/themes/CreativeTheme/video/loop.jpg"></video>';
    ...
    var createFrame = function() {
        ...
        if(videoDetails.provider === 'youtube') {
            ...
            var html = '<iframe id="Alpha" src="http://player.vimeo.com/video/'+videoDetails.id+'?title=0&amp;byline=0&amp;portrait=0&amp;color=3d96d2&autoplay=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        }
        else if(videoDetails.provider === 'html5') {
            var html = '<video autoplay="true" id="Alpha" controls><source src="'+videoDetails.id+'.mp4" type="video/mp4"><source src="'+videoDetails.id+'.ogv" type="video/ogg"></video>';
        }
        return html;
    };
