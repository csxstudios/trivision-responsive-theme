<?php
/*
 * Template Name: Subpage Thumbnails
...
?>
			...
			<section class="subpages container">
				...
				?>
				<div class="col-md-3 blocks text-center <?php if($queryCount == 3 and $counter == 1) {echo 'col-md-offset-1_5';} ?>">
					<a href="<?php echo $worklink; ?>">
					<figure class="block-lg">
					<img class="img-responsive" src="<?php echo $workthumb; ?>" alt="<?php echo $worktitle; ?>"/>
					<figcaption><?php echo $worktitle; ?></figcaption>
					</figure>
					</a>
				</div>
				<?php
